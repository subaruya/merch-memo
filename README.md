...
- 予約開始待ちの欲しいグッズや予約済グッズの名前や予約日、予約サイト、発売予定日を記録・検索でき、予約忘れ・重複注文の防止や管理のサポートをすることを目的としています。
- また、単に管理を行うだけでなく、予約したグッズたちの情報を一覧にして時折眺めることで「ただ待つ時間」が「楽しみに待つ時間」に変わり、より快適で楽しいグッズ収集ライフの一助となることをも期待しています。

### MVPで実装する予定の機能
- [x] ユーザー登録機能
- [x] ログイン機能
- [x] グッズ情報の登録機能（名前[必須]・予約サイト[必須]・予約日[必須]・発売予定日・価格・メモ）
- [x] グッズ情報の編集機能
- [x] グッズ情報の削除機能
- [x] グッズ情報の詳細閲覧機能
- [x] グッズ情報の検索機能（名前・予約サイトの部分一致検索が可能）
- [x] グッズ情報の一覧表示機能
